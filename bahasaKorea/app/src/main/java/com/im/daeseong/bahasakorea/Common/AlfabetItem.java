...
public class AlfabetItem  extends ConstraintLayout{

    private TextView tv1;
    private String sText;

    public AlfabetItem(Context context){
        super(context);
        init(context);
    }

    public AlfabetItem(Context context, AttributeSet attributeSet){
        super(context, attributeSet);
        init(context);
    }

    public AlfabetItem(Context context, AttributeSet attributeSet, int defStyle) {
    ...
    public void setResourceType(int nResource){
