...
import com.daeseong.bahasakorea.Database.HangulItems
...
class MainTab2Fragment : Fragment() {
    ...
    private var item: HangulItems? = null
    ...
    private fun CurrentKata() {
        ...
        try {
            ...
            tv1!!.text = item!!.KataFirst
            tv2!!.text = item!!.KataSecond
            tv3!!.text = item!!.KataEnd

            CounterTimerLabel()

            //현재 프레그멘트 활성화시만 음성 출력
            if (bActivityFragment) {
                PlaySuaraSound(item!!.KataFirst)
            }
